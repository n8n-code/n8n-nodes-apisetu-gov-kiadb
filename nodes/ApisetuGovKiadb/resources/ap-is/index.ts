...
export const apIsDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					"name": "Bknoc",
					"value": "Bknoc",
					"action": "NOC For Banks",
					"description": "API to verify NOC For Banks.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/bknoc/certificate"
						}
					}
				},
				{
				...
				},
				{
					"name": "Cfltr",
					"value": "Cfltr",
					"action": "Confirmatory Letter",
					"description": "API to verify Confirmatory Letter.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/cfltr/certificate"
						}
					}
				},
				{
					"name": "Lcsag",
					"value": "Lcsag",
					"action": "Lease cum Sale Agreement",
					"description": "API to verify Lease cum Sale Agreement.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/lcsag/certificate"
						}
					}
				},
				{
				...
				},
				{
					"name": "Psnoc",
					"value": "Psnoc",
					"action": "NOC for New Power Supply",
					"description": "API to verify NOC for New Power Supply.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/psnoc/certificate"
						}
					}
				},
				{
					"name": "Wtrbl",
					"value": "Wtrbl",
					"action": "Water Bill/ Connection",
					"description": "API to verify Water Bill/ Connection.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/wtrbl/certificate"
						}
					}
				}
			],
		...
		{
			"displayName": "POST /alltr/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /bknoc/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /bpcer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /cfltr/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /lcsag/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /psnoc/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /wtrbl/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
